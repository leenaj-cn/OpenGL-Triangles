...
void render(void)
{
	...
	theta+= 0.01f; //the rotation speed
    ...
    MathHelper::makeTranslate(V, 0.1f, -0.1f, 0.1f);			// Fill the (V)iew matrix to push the world up 1 unit
...
int main(int argc, char** argv)
{
	...
	glutCreateWindow("small phlegm - Diffuse Lighting");
    ...
    glVertexAttribPointer(normalID, 3, GL_FLOAT, GL_FALSE, 0, ((char*)NULL + sizeof(vertices)) );
	...
	glCullFace(GL_FRONT);	// Other options?  GL_FRONT and GL_FRONT_AND_BACK
